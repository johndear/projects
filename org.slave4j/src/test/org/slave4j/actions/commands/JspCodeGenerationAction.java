...
public class JspCodeGenerationAction extends AbstractHandler {
	/**
	 * The constructor.
	 */
	public JspCodeGenerationAction() {
	}
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		JspCodeGenerationWizard wizard = null;//new JspCodeGenerationWizard();
