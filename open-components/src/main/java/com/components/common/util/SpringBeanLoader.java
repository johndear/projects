 ...
 * 方法获取SpringBean.<br>
 * (2)、您也可以直接�?过我们提供的getSpringBean()方法活得SpringBean�? * 
 * @author XiongChun
 * @since 2009-07-22
 */
public class SpringBeanLoader{
	 ...
	 * 
	 * @param pBeanId
	 *            Spring配置文件名中配置的SpringID�?	 * @return Object 返回的SpringBean实例
	 */
	public static Object getSpringBean(String pBeanId) {
		...
		try {
			...
			log.error(G4Constants.Exception_Head + "Spring配置文件中没有匹配到ID号为:[" + pBeanId + "]的SpringBean组件,请检�?");
